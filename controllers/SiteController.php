...
class SiteController extends Controller
{
    ...
    public function actionHello1($nama="Raven Rivaldo")
    {
    ...
    */
    ...
    public function actionEntry(){
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate())
        {
            ...
            // lakukan sesuatu terhafap $model di sini ...
            return $this->render('entry-confirm', ['model' => $model]);
        }
        else {
            //menampilkan from pada halaman, adaatau tidaknya kegagalan validasi tidak maslaah
